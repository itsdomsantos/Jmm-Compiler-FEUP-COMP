...
- André Cruz, 201705768, 14 , 20%
- Domingos Santos , 201906680, 13 , 15%
- Edgar Torre, 201906573, 15 , 25%
- Luís Assunção , 201806140,19 , 40%

## GLOBAL Grade of project: 15

## Summary
Our project fullfills the basic requirements, such as AST and Symbol Table Generation, Ollir and Jasmin technology, some optimizations passes most of the given tests.

## Semantic Analysis
Regarding the Semantic Analysis, our code is capable of verifying the type of operations, if invoked functions or methods exist, their expected arguments, if we are operating with different type of values, and much more. Regarding the given tests, our code fits all the requirements and challenges implied by those tests. No additional features where coded rather than the ones testes by the unit tests.
...
## Cons:
Missing control flow and advanced arithmetic in OLLIR generation.
